...
Kuzu 0.2.0 introduces native support for RDF through a new extension of its data model called [*RDFGraphs*](//kuzudb.github.io/docs/rdf-graphs/example-rdfgraph).
...
go-to system to model your records as graphs. Here is the example from our [documentation](//kuzudb.github.io/docs/rdf-graphs/example-rdfgraph) 
...
the property graph node and relationships they map to, how to query and modify them and all in [our documentation page for RDFGraphs](//kuzudb.github.io/docs/rdf-graphs/).
...
[Extensions](//kuzudb.github.io/docs/extensions/) are a way to add new features to Kuzu without modifying the core code.
...
RETURN *;
```
You can also write to S3 using the `httpfs` extension. Read all about it here in our [documentation](//kuzudb.github.io/docs/extensions/httpfs).
