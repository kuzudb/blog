...
To install the new version, please visit the [download section of our website](https://kuzudb.github.io/#download) 
and [getting started guide](//kuzudb.github.io/docs/getting-started/). The full
...
See more details on supported macro expression types [here](//kuzudb.github.io/docs/cypher/macro/).

### C++ UDFs
We are also introducing two C++ interfaces, `createScalarFunction` and `createVectorizedFunction` in the `Connection` class of the [C++ API](//kuzudb.github.io/docs/getting-started/cpp) to define both scalar and vectorized [UDFs](//kuzudb.github.io/docs/client-apis/cpp-api/udf/).
...
See [our doc here](//kuzudb.github.io/docs/client-apis/cpp-api/udf) for more details.
...
See [our doc here](//kuzudb.github.io/docs/cypher/data-manipulation-clauses/merge) for more details.
...
See our docs in [Set](//kuzudb.github.io/docs/cypher/data-manipulation-clauses/set) and [Delete](//kuzudb.github.io/docs/cypher/data-manipulation-clauses/delete) for more details.
...
See our docs in [Set](//kuzudb.github.io/docs/cypher/data-manipulation-clauses/set) and
[Delete](//kuzudb.github.io/docs/cypher/data-manipulation-clauses/delete) for more examples.
...
See [our doc here](//kuzudb.github.io/docs/cypher/query-clauses/return#returning-node-and-relationship-properties) for more details.
...
"Noura",25
```
See [Data Export](//kuzudb.github.io/docs/data-export/) for more information.
...
See [map](//kuzudb.github.io/docs/cypher/data-types/map) for more information.
...
See [union](//kuzudb.github.io/docs/cypher/data-types/union) for more information.

### Converting Query Results to Arrow
In previous releases, we supported converting query result to Arrow tables in our [Python API](https://kuzudb.github.io/api-docs/python/kuzu/query_result.html#QueryResult.get_as_arrow).
In this release, converting to Arrow arrays are now also available in Rust, [C](https://kuzudb.github.io/api-docs/c/kuzu_8h.html) (see `kuzu_query_result_get_arrow_schema` and `kuzu_query_result_get_next_arrow_chunk`), and [C++](https://kuzudb.github.io/api-docs/cpp/classkuzu_1_1main_1_1_query_result.html) (see `getArrowSchema` and `getNextArrowChunk`) APIs.
