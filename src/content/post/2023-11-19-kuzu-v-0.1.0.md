...
Details of this feature can be found [here](//kuzudb.github.io/docs/cypher/query-clauses/call#read_pandas).
...
of this feature can be found [here](//kuzudb.github.io/docs/cypher/copy).

### Updates

#### Detach Delete

Kuzu now supports Cypher's [DETACH DELETE](//kuzudb.github.io/docs/cypher/data-manipulation-clauses/delete#detach-delete) clause,
...
Details of this feature can be found [here](//kuzudb.github.io/docs/cypher/data-manipulation-clauses/read-after-update).
...
Details of the `cast` function can be found [here](//kuzudb.github.io/docs/cypher/expressions/casting).
...
Details of this feature can be found [here](//kuzudb.github.io/docs/cypher/query-clauses/match#filter-variable-length-relationships).
...
```
The details of count subqueries can be found [here](//kuzudb.github.io/docs/cypher/subquery#count-subquery).
