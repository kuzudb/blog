...
Then, you can follow our [API documentation](https://kuzudb.github.io/docs/client-apis/wasm/) to integrate it into your projects. To see Kuzu-WASM in action,
...
For more details on how to use FTS in Kuzu, you can check out our documentation [here](https://kuzudb.github.io/docs/extensions/full-text-search/). 
...
find more detailed documentation [here](https://kuzudb.github.io/docs/cypher/data-definition/create-table/#create-a-relationship-table).

### DataFrame usability improvements

#### Skipping erroneous rows when copying from DataFrame

In our [prior release](https://kuzudb.github.io/blog/post/kuzu-0.7.0-release/#allow-skipping-erroneous-rows-during-copyload-from), we had introduced a feature that allows users to skip erroneous or malformed rows when copying 
...
```
More details can be found in our [docs](https://kuzudb.github.io/docs/import/copy-from-dataframe/#ignore-erroneous-rows). 
The same functionality also works for using `LOAD FROM` (see [here](https://kuzudb.github.io/docs/cypher/query-clauses/load-from#ignore-erroneous-rows)),
...
For more details on skipping rows, check our [docs](https://kuzudb.github.io/docs/cypher/query-clauses/skip/).
