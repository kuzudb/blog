...
For installing the new version, please visit the [installation guide](https://kuzudb.github.io/docs/getting-started.html) and
the full
...
Our [Python API](https://kuzudb.github.io/api-docs/python/) now has a 
new [`QueryResult.get_as_torch_geometric()`](https://kuzudb.github.io/api-docs/python/kuzu/query_result.html#QueryResult.get_as_torch_geometric) function that 
...
Our [Python API](https://kuzudb.github.io/docs/client-apis/python-api/overview.html) now has a 
new [`QueryResult.get_as_networkx()`](https://kuzudb.github.io/api-docs/python/kuzu/query_result.html#QueryResult.get_as_networkx) function that can convert query results
...
as our default library when bulk importing data through [`COPY FROM` statements](//kuzudb.github.io/docs/data-import/csv-import). 
...
we infer that this is a parquet file and parse it so. See the details [here](//kuzudb.github.io/docs/data-import/parquet-import).
...
2) Support of [regex pattern matching](//kuzudb.github.io/docs/cypher/expressions/pattern-matching) with strings. Kuzu now supports Cypher's `=~` operator for regex searches, which will return true if its pattern mathces the entire input string. For example: `RETURN 'abc' =~ '.*(b|d).*';`.

### CASE Expression
We've added [CASE](//kuzudb.github.io/docs/cypher/expressions/case-expression) for conditional expressions.
Two forms ([Simple Form](//kuzudb.github.io/docs/cypher/expressions/case-expression#simple-form) and [General Form](//kuzudb.github.io/docs/cypher/expressions/case-expression#general-form)) of CASE expression are supported.

### ALTER/DROP/SET/DELETE
We added [ALTER TABLE](//kuzudb.github.io/docs/cypher/data-definition/alter) and [DROP TABLE](//kuzudb.github.io/docs/cypher/data-definition/drop) DDL statements.
...
Besides schema level changes, you can change properties of existing nodes/rels with [SET](//kuzudb.github.io/docs/cypher/data-manipulation-clauses/set) statements, and remove existing nodes/rels with [DELETE](//kuzudb.github.io/docs/cypher/data-manipulation-clauses/delete) statements.
