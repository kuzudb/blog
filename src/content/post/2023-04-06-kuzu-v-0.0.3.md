...
please visit the [download section of our website](https://kuzudb.github.io/#download) 
and [getting started guide](https://kuzudb.github.io/docs/getting-started.html) and the full
[release notes are here](https://github.com/kuzudb/kuzu/releases). Please visit
the [Colab Notebooks](https://kuzudb.github.io/docs/getting-started/colab-notebooks) section of our
documentation website to play with our [Colab notebooks](https://kuzudb.github.io/docs/getting-started/colab-notebooks).
...
**[FIXED-LIST](//kuzudb.github.io/docs/cypher/data-types/list/) data type:** This is important if you're doing graph ML and storing node features
...
When possible use FIXED LIST instead of regular [VAR-LIST](//kuzudb.github.io/docs/cypher/data-types/list/) data type
