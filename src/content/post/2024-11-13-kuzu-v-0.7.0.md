...
The recommended (fast) way to ingest large amounts of data into Kuzu is the [`COPY FROM`](https://kuzudb.github.io/docs/import/) statement.
...
attaching to external DuckDB, Postgres, and SQLite databases using Kuzu's [external RDBMSs extension](https://kuzudb.github.io/docs/extensions/attach/rdbms/).
...
To use this data type, you need to install the [JSON extension](https://kuzudb.github.io/docs/extensions/json/).
Along with this data type, we also provide a set of [functions](https://dev-kuzudb.github.io/docs/extensions/json/#json-functions)
...
More details can be found in our [docs](https://kuzudb.github.io/docs/import#ignore-erroneous-rows). The same functionality also works
for using [`LOAD FROM`](https://kuzudb.github.io/docs/cypher/query-clauses/load-from#ignore-erroneous-rows).
...
and apply them when using them with `COPY/LOAD FROM` statements. See our [docs](https://kuzudb.github.io/docs/import/csv/) for some
...
scan and load data from it. See the external RDBMS [docs](https://kuzudb.github.io/docs/extensions/attach/rdbms/) for more details.
...
discuss your RDF use cases further, please join us on [Discord](https://kuzudb.github.io/chat)
