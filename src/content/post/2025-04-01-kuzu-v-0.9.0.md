...
10K queries for each dataset when k is 100 (and [efs parameter](https://kuzudb.github.io/docs/extensions/vector/#query-the-vector-index) set to 200). These queries do not contain any filters:
...
querying and even debugging your graph data.
