...
announce Kuzu 0.9.0! The highlight of this release is a brand new [`vector`](https://kuzudb.github.io/docs/extensions/vector/) extension, which enables
...
Kuzu's vector index is provided as an [extension](https://kuzudb.github.io/docs/extensions/vector/).
...
subset of records, which we refer to as performing a *filtered search*. To perform a filtered search, we use a [projected graph](https://kuzudb.github.io/docs/extensions/vector/#what-is-a-projected-graph)
...
10K queries for each dataset when k is 100 (and [efs parameter](https://dev-kuzudb.github.io/docs/extensions/vector/#query-the-vector-index) set to 200). These queries do not contain any filters:
...
In a previous release, we introduced the [Postgres extension](https://kuzudb.github.io/docs/extensions/attach/rdbms/) which enabled scanning from PostgreSQL tables. 
...
You can find more information on this feature [here](https://kuzudb.github.io/docs/extensions/attach/postgres/#5-scan-from-postgresql-tables-with-sql).

## WASM with bundled extensions

One limitation of the initial [Wasm version](https://kuzudb.github.io/docs/client-apis/wasm/) of Kuzu was the
...
custom graph visualizations on larger graphs. Check out the [docs](https://kuzudb.github.io/docs/visualization/third-party-integrations/gdotv/)
...
querying and even debugging your graph data -- see our recent [blog post](https://kuzudb.github.io/blog/post/2025-03-23-kuzu-mcp-server/)
...
See the [Python client](https://kuzudb.github.io/docs/client-apis/python/#sync-and-async-apis) API docs
for more details.

### Sync Node.js API

For more feature completeness and for cases where a synchronous API is required, we now provide
a synchronous API for our Node.js users. See the [Node.js client](https://kuzudb.github.io/docs/client-apis/nodejs/#sync-and-async-apis)
...
let us know what you think on [Discord](https://kuzudb.github.io/chat).
