...
See the documentation for weighted shortest paths [here](https://kuzudb.github.io/docs/cypher/query-clauses/match/#shortest-path).
We will be implementing many more algorithms in our future releases, so stay tuned!

### Using graph algorithms

All algorithms, except for [weighted shortest paths](https://kuzudb.github.io/docs/cypher/query-clauses/match#shortest-path) which is provided through the built-in `CALL` clause, 
are available via the [`algo` extension](https://kuzudb.github.io/docs/extensions/algo). 
...
Kuzu's graph algorithms extension a try, and check out the [docs](https://kuzudb.github.io/docs/extensions/algo) here.
...
To make it easier to migrate graph data from Neo4j to Kuzu, we introduce a [`neo4j`](https://kuzudb.github.io/docs/extensions/neo4j) extension, 
...
You can find more details on setting up the APOC extension in Neo4j [here](https://kuzudb.github.io/docs/extensions/neo4j/#set-up-the-neo4j-apoc-extension).
Read more on Kuzu's Neo4j extension [here](https://kuzudb.github.io/docs/extensions/neo4j).
...
You can use Kuzu's [Java API](https://kuzudb.github.io/docs/client-apis/java/), which works directly with Android Studio projects.
...
data in compressed CSV format, such as object stores. See [here](https://kuzudb.github.io/docs/import/csv/#compressed-csv-files)
...
activity on our [Discord server](https://kuzudb.github.io/chat) than ever before. Thank you all for your
