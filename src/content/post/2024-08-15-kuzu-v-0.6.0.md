...
See our [documentation page](https://kuzudb.github.io/docs/get-started/#in-memory-database)
...
Read more details about this feature on the [documentation page](https://kuzudb.github.io/docs/client-apis/cli/#output-modes).
...
features a try, come on over to our [Discord](https://kuzudb.github.io/chat) with your feedback. Till next time, have fun using Kuzu!