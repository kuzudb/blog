...
Check out the [docs](https://kuzudb.github.io/docs/extensions/attach/unity/) for more information on how to use Kuzu with Unity Catalog.
...
to us on [Discord](https://kuzudb.github.io/chat) and let us know how it's going!
...
You can check out the documentation for our GCS feature [here](https://kuzudb.github.io/docs/extensions/httpfs/#gcs-file-system).
