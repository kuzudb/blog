...
heroImage: "/blog/img/improving-text2cypher-for-graphrag/context-engineering-information-theory.png"
categories: ["example"]
authors: ["prashanth"]
...
<img src="/blog/img/improving-text2cypher-for-graphrag/context-engineering-information-theory.png" alt="Context engineering through the lens of information theory" width=700 />
...
<img src="/blog/img/improving-text2cypher-for-graphrag/ldbc-snb-graph-schema.png" alt="LDBC-SNB conceptual graph schema in Kuzu" />
...
to manage the prompts for Text2Cypher. As described in an [earlier post](/blog/post/enhancing-graph-rag-with-vector-search#graph-rag-with-baml),
...
<img src="/blog/img/improving-text2cypher-for-graphrag/full-schema-results.png" alt="Text2Cypher results using the full graph schema in JSON, XML and YAML formats" width=500 />
...
<img src="/blog/img/improving-text2cypher-for-graphrag/schema-pruning-prompt.png" alt="Prompt for pruning the graph schema" />
...
<img src="/blog/img/improving-text2cypher-for-graphrag/final-results.png" alt="Text2Cypher results using the full vs. pruned graph schema in JSON, XML and YAML formats" />
